    ...
    <>
      <div>
        ...
        <div className="space-y-10">
          ...
          <Button variant="outline">OUTLINE</Button>z
          ...
          <Button variant="danger" size="lg" className="w-48 mx-auto">
            DANGER w-48
          </Button>
          <Button variant="outline" size="lg" className="w-48 mx-auto">
            OUTLINE w-48
          </Button>
          <Button variant="primary" size="lg" className="w-48 mx-auto">
            PRIMARY w-48
          </Button>
          <Input />
          <Label htmlFor="email">
            {" "}
            Probando Label (la línea debajo es un hr)
          </Label>
          <hr />
          <InputLabel
            type="email"
